...
namespace VectorMath.Benchmarks
{
	...
	public class Matrix4x4MultiplyBenchmarks
	{
		...
		private VectorMath.Mat4x4 mat2;
		...
		public VectorMath.Mat4x4 MultiplyNormal() {
			return VectorMath.Mat4x4.Multiply(mat1, mat2);
		}

		[Benchmark]
		public VectorMath.Mat4x4 MultiplyRef()
		{
			return VectorMath.Mat4x4.MultiplyRef(mat1, mat2);
		}
