...
namespace ECSCoreBenchmarks
{
	...
	public class VectorAddBenchmarks
	{
		...
		public float SseAdd()
		{
			VectorMath.Vector3Sse.Add(vec1, vec2, vec1);
		...
		public float AvxAdd()
		{
			VectorMath.Vector3Avx.Add(vec1, vec2, vec1);
		...
		{
			VectorMath.Vector3Sse.Multiply(vec1, vec2, vec1);
		...
		{
			VectorMath.Vector3Avx.Multiply(vec1, vec2, vec1);
		...
		{
			VectorMath.Vector3Avx.Normalize(vec2, vec1);
