...
namespace Core.ECS.Numerics
{
	public static class Mat4x4Sse
	{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
		public static unsafe Mat4x4 Multiply(Mat4x4 left, Mat4x4 right) {
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
		public static unsafe Mat4x4 Transpose(Mat4x4 source)
		{
			Mat4x4 result = new Mat4x4();
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
		public static unsafe Mat4x4 TransposeRef(Mat4x4 source)
		{
			Mat4x4 result = new Mat4x4();
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
		public static unsafe Mat4x4 TransposeStore(Mat4x4 source)
		{
			Mat4x4 result = new Mat4x4();
