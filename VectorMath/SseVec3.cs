...
namespace VectorMath
{
	public ref struct SseVec3
	{
		...
		public unsafe SseVec3(ReadOnlySpan<Vec3> origin, int offset)
		{
		...
		public SseVec3 Add(in SseVec3 other)
		{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public SseVec3 Multiply(in SseVec3 other)
		{
			return new SseVec3()
			{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public unsafe SseVec3 Multiply(float scalar)
		{
