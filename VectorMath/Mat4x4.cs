...
namespace VectorMath
{
	...
	public struct Mat4x4 {
		...
		public Mat4x4(float r1C1, float r1C2, float r1C3, float r1C4, float r2C1, float r2C2, float r2C3, float r2C4, float r3C1, float r3C2, float r3C3, float r3C4, float r4C1, float r4C2, float r4C3, float r4C4) {
			r1c1 = r1C1;
			r1c2 = r1C2;
			r1c3 = r1C3;
			r1c4 = r1C4;
		...
		[MethodImpl(MethodImplOptions.AggressiveOptimization)]
		public static Mat4x4 MultiplyRef(in Mat4x4 left, in Mat4x4 right)
		{
			Mat4x4 result = new Mat4x4
			{
				r1c1 = left.r1c1 * right.r1c1 + left.r2c1 * right.r1c2 + left.r3c1 * right.r1c3 + left.r4c1 * right.r1c4,
		...
		public static Mat4x4 Transpose(Mat4x4 src) {
			return new Mat4x4(
		...
		public static Mat4x4 TransposeRef(in Mat4x4 src)
		{
			return new Mat4x4(
				src.r1c1, src.r2c1, src.r3c1, src.r4c1,
				src.r1c2, src.r2c2, src.r3c2, src.r4c2,
