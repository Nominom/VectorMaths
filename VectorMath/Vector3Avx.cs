...
namespace VectorMath
{
	public static class Vector3Avx
	{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
		public static unsafe void Add(ReadOnlySpan<Vec3> left, ReadOnlySpan<Vec3> right, Span<Vec3> result)
		{
			...
			fixed (Vec3* lefts = left)
			fixed (Vec3* rights = right)
			fixed (Vec3* res = result)
			{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
		public static unsafe void Subtract(ReadOnlySpan<Vec3> left, ReadOnlySpan<Vec3> right, Span<Vec3> result)
		{
			if (left.Length != right.Length || left.Length != result.Length)
			{
				throw new ArgumentException("All spans should be the same length");
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
		public static unsafe void Multiply(ReadOnlySpan<Vec3> left, ReadOnlySpan<Vec3> right,
			Span<Vec3> result) {
			if (left.Length != right.Length || left.Length != result.Length) {
				throw new ArgumentException("All spans should be the same length");
			}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
		public static unsafe void MultiplyScalars(ReadOnlySpan<Vec3> left, ReadOnlySpan<float> right, Span<Vec3> result)
		{
			if (left.Length != right.Length || left.Length != result.Length)
			{
				throw new ArgumentException("All spans should be the same length");
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
		public static unsafe void MultiplyScalar(ReadOnlySpan<Vec3> left, float right, Span<Vec3> result)
		{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
		public static unsafe void Normalize(ReadOnlySpan<Vec3> source, Span<Vec3> destination)
		{
			...
			fixed (Vec3* srcP = source)
			fixed (Vec3* dstP = destination)
			{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
		public static unsafe void NormalizeAvx2(ReadOnlySpan<Vec3> source, Span<Vec3> destination)
		{
			if (source.Length != destination.Length)
			{
				throw new ArgumentException("All spans should be the same length");
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
		public static unsafe void Dot(ReadOnlySpan<Vec3> left, ReadOnlySpan<Vec3> right, Span<float> result)
		{
			if (left.Length != right.Length || left.Length != result.Length)
			{
				throw new ArgumentException("All spans should be the same length");
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
		public static unsafe void Cross(ReadOnlySpan<Vec3> left, ReadOnlySpan<Vec3> right, Span<Vec3> result)
		{
			if (left.Length != right.Length || left.Length != result.Length)
			{
				throw new ArgumentException("All spans should be the same length");
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
		public static unsafe void Reflect(ReadOnlySpan<Vec3> dirs, ReadOnlySpan<Vec3> normals, Span<Vec3> result)
		{
			...
			fixed (Vec3* lefts = dirs)
			fixed (Vec3* rights = normals)
			fixed (Vec3* res = result)
			{
				float* lfP = (float*)lefts;
				float* rfP = (float*)rights;
